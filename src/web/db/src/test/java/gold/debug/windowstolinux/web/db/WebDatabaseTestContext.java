...
public final class WebDatabaseTestContext implements AutoCloseable {
    ...
    public WebDatabaseTestContext(Path root) throws Exception {
        ...
        try {
            context.refresh();
            context.getBean(WebPersistence.class).initializeInternalScope();
    ...
    public WebResourceRepository resources() {
        return context.getBean(WebResourceRepository.class);
    }

    public WebTaskRepository tasks() {
        return context.getBean(WebTaskRepository.class);
    }

    public WebSecretRepository secrets() {
        return context.getBean(WebSecretRepository.class);
    }
