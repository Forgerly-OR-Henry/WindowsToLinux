...
final class DistributionPolicySupport {
    private DistributionPolicySupport() {
    }

    static HostSupport requireCpu(LinuxCapabilities capabilities, CpuMicroarchitectureLevel required,
    ...
    static HostSupport requireEnforcingSelinux(LinuxCapabilities capabilities, String distribution,
    ...
    static HostSupport unsupported(String detail, List<String> evidence) {
        evidence.add(detail);
