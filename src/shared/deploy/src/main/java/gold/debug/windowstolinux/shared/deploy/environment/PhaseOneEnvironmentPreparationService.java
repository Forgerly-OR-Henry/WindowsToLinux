 ...
 */
public final class PhaseOneEnvironmentPreparationService {
    /**
     ...
     */
    public PhaseOneEnvironmentPreparationResult prepare(
            PhaseOneEnvironmentPreparationApproval approval,
        ...
        try {
            ...
            try (PhaseOneRemoteSession session = gateway.connect(endpoint, connectionCredential(credential), hostKeyVerifier)) {
                return session.preparePhaseOneEnvironment(approval);
            }
        } finally {
