package gold.debug.windowstolinux.shared.deploy.support.distro.registry;

import gold.debug.windowstolinux.shared.deploy.support.HostSupport;
import gold.debug.windowstolinux.shared.deploy.support.distro.policy.almalinux.AlmaLinuxSupportPolicy;
import gold.debug.windowstolinux.shared.deploy.support.distro.policy.centosstream.CentosStreamSupportPolicy;
import gold.debug.windowstolinux.shared.deploy.support.distro.policy.debian.DebianSupportPolicy;
import gold.debug.windowstolinux.shared.deploy.support.distro.policy.oraclelinux.OracleLinuxSupportPolicy;
import gold.debug.windowstolinux.shared.deploy.support.distro.policy.rocky.RockyLinuxSupportPolicy;
import gold.debug.windowstolinux.shared.deploy.support.distro.policy.ubuntu.UbuntuSupportPolicy;
...
public final class DistributionSupportRegistry {
