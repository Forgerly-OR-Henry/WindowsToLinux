 ...
 */
public record ComponentLifecycleResult(String componentId, boolean actionAttempted, boolean accepted,
        LocalizedMessage message, Optional<LifecycleObservation> observation) {
    /**
