package gold.debug.windowstolinux.shared.deploy.support.distro.policy.centosstream;
...
public final class CentosStreamSupportPolicy implements DistributionSupportPolicy {
    ...
    public HostSupport evaluate(LinuxCapabilities capabilities, List<String> evidence) {
        ...
        HostSupport cpu = DistributionSupportRules.requireCpu(capabilities, required, "CentOS Stream", evidence);
