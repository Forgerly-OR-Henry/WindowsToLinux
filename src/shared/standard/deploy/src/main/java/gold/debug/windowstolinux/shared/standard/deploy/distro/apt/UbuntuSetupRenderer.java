...
public final class UbuntuSetupRenderer implements DistributionSetupRenderer {
     ...
     * <p>额外软件包集合2404。
     */
    private static final List<String> ADDITIONAL_PACKAGES_2404 = List.of("golang-go", "rustc", "cargo",
            "dotnet-sdk-8.0", "php-cli", "composer", "ruby", "ruby-bundler");
    ...
    public String render(LinuxCapabilityFacts facts, String username) {
        ...
        if (ubuntu2404)
            packages.addAll(ADDITIONAL_PACKAGES_2404);
        EcosystemCapabilityProfile checks = ubuntu2404
                ? EcosystemCapabilityProfile.UBUNTU_2404
                : EcosystemCapabilityProfile.UBUNTU_2204;
        return AptSetupRenderer.render(new DistributionSetupProfile("ubuntu", "", version, "amd64",
                CpuMicroarchitectureLevel.X86_64_V1, packages, checks), username, "");
    }
}
