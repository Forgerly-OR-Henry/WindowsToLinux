 ...
 */
public record ReviewedComponentDeployment(String componentId, ReviewedDeploymentRequest request,
    ...
    public ReviewedComponentDeployment {
        ...
        resourceBindings = new ManagedComponentResourceBindings(request.fileBindings(),
                resourceBindings.databaseBindings());
        if (!request.databaseBindings().equals(resourceBindings.databaseBindings()))
            throw new IllegalArgumentException("database resource bindings differ from reviewed request");
