package gold.debug.windowstolinux.shared.standard.deploy.extension.registry;
...
import gold.debug.windowstolinux.shared.standard.deploy.extension.adapter.ContainerAdapter;
import gold.debug.windowstolinux.shared.standard.deploy.extension.adapter.ServiceDeploymentAdapter;
import gold.debug.windowstolinux.shared.standard.deploy.extension.adapter.ServiceDeploymentProfile;
import gold.debug.windowstolinux.shared.standard.deploy.extension.adapter.StaticSiteAdapter;
...
public final class DeploymentAdapterRegistry {
    ...
    public static DeploymentAdapterRegistry defaults() {
        List<DeploymentAdapter> adapters = new java.util.ArrayList<>(
                ServiceDeploymentProfile.defaults().stream().map(ServiceDeploymentAdapter::new).toList());
