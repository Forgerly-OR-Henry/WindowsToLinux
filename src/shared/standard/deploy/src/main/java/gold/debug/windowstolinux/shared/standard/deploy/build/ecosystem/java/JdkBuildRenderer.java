...
public final class JdkBuildRenderer implements DeploymentBuildRenderer {
    ...
    public Set<DeploymentBuildToolType> buildTools() {
        return Set.of(DeploymentBuildToolType.JDK);
    }
    ...
    public String render(DeploymentProjectFacts facts, DeploymentRuntimeSpecification runtime,
        ...
        String command = """
                ...
                printf 'ARTIFACT=%%s\n' ./.w2l/java/app.jar
                """.formatted(javaSource.javaVersion(), SafeBuildScriptEnvelope.shellQuote(javaSource.javaVersion()),
                sourceRoot, mainClass);
