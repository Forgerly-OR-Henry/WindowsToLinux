...
import gold.debug.windowstolinux.shared.standard.deploy.distro.extension.registry.DistributionSetupCatalog;
...
public final class DistributionSetupRegistry
        implements
            gold.debug.windowstolinux.shared.linux.distro.EnvironmentPreparationPlan {
    /**
     * Preparations.
     * <p>准备集合。
     */
     ...
     */
    @Override
    public String render(LinuxCapabilityFacts capabilities, String username) throws LinuxOperationException {
