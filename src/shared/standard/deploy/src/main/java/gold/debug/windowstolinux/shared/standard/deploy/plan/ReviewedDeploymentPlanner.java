...
import gold.debug.windowstolinux.shared.standard.deploy.extension.registry.DeploymentAdapterRegistry;
...
public final class ReviewedDeploymentPlanner {
    ...
    public ReviewedDeploymentPlan plan(ReviewedDeploymentRequest request) {
        ...
        gold.debug.windowstolinux.shared.standard.deploy.input.ApplicationDeclaration
                .verifyBuildOwnership(request.facts(), request.runtime());
