...
public final class SetupScriptRenderer {
    ...
    public static String renderJava21RuntimeInstallation() {
        return """
                ...
                """.formatted(quote("/usr/local/lib/windowstolinux"), quote("/usr/local/lib/windowstolinux/java-21"));
    }
    ...
    public static String renderCommonChecks() {
        return """
                ...
                """.formatted(SetupScriptRenderer.quote("/usr/local/lib/windowstolinux/java-21"),
                SetupScriptRenderer.quote("/usr/local/lib/windowstolinux/java-21"));
    }
}
