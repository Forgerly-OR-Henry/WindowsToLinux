...
public final class AlmaLinuxSetupRenderer implements DistributionSetupRenderer {
    ...
    public String render(LinuxCapabilityFacts facts, String username) throws LinuxOperationException {
        ...
        if (!("9.8".equals(version) || "10.2".equals(version)) || !"x86_64".equals(facts.packageArchitecture())) {
        ...
        return DnfSetupRenderer.render(
                new DistributionSetupProfile("almalinux", "", version, facts.packageArchitecture(),
