package gold.debug.windowstolinux.shared.standard.analyze.ecosystem.python.pip;
...
public final class PipBuildInspector {
    ...
    public Optional<String> inspect(Path root) throws IOException {
        ...
        boolean valid = logical.lines().map(String::trim).filter(line -> !line.isEmpty() && !line.startsWith("#"))
