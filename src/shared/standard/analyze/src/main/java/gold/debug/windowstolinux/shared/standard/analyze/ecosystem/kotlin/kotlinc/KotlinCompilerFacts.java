 ...
 */
public record KotlinCompilerFacts(String compilerVersion, String sourceRoot, String mainClass, List<String> sourceFiles,
        List<String> missingItems, List<String> conflicts) {
    /**
