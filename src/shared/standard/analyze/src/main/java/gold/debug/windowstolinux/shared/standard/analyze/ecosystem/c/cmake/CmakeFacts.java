 ...
 */
public record CmakeFacts(String preset, String target, Set<SourceLanguageType> sourceLanguages,
        List<String> targetSources, List<String> missingItems, List<String> conflicts) {
    /**
