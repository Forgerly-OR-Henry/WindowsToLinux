package gold.debug.windowstolinux.shared.analyze.ecosystem.ruby.project.service;
...
/** Provides the {@code RubyServiceDeploymentInspector} type. / 提供 {@code RubyServiceDeploymentInspector} 类型。 */
public final class RubyServiceDeploymentInspector implements DeploymentTypeInspector {
    private final ServiceDeploymentInspectorSupport support = new ServiceDeploymentInspectorSupport(DeploymentProjectType.RUBY_SERVICE);
