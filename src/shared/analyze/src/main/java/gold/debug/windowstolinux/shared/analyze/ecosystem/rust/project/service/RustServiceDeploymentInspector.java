package gold.debug.windowstolinux.shared.analyze.ecosystem.rust.project.service;
...
/** Provides the {@code RustServiceDeploymentInspector} type. / 提供 {@code RustServiceDeploymentInspector} 类型。 */
public final class RustServiceDeploymentInspector implements DeploymentTypeInspector {
    private final ServiceDeploymentInspectorSupport support = new ServiceDeploymentInspectorSupport(DeploymentProjectType.RUST_SERVICE);
