...
import gold.debug.windowstolinux.shared.analyze.ecosystem.jvm.build.gradle.GradleBuildFacts;
import gold.debug.windowstolinux.shared.analyze.ecosystem.jvm.build.gradle.GradleBuildInspector;
import gold.debug.windowstolinux.shared.analyze.ecosystem.jvm.build.maven.MavenBuildFacts;
import gold.debug.windowstolinux.shared.analyze.ecosystem.jvm.build.maven.MavenBuildInspector;
...
public final class SpringBootDeploymentInspector implements DeploymentTypeInspector {
    ...
    public DeploymentTypeInspection inspect(Path root, SourceInspection source, ProjectLanguageFacts languageFacts,
        ...
        boolean hasMaven = BoundedMetadataReader.regular(root.resolve("pom.xml"));
        boolean hasGradle = BoundedMetadataReader.regular(root.resolve("build.gradle"))
                || BoundedMetadataReader.regular(root.resolve("build.gradle.kts"));
    ...
    private BuildInspection inspectMaven(Path root, List<RejectionReason> rejections) {
        ...
        boolean hasMavenWrapper = BoundedMetadataReader.regular(root.resolve("mvnw"));
        boolean hasWindowsMavenWrapper = BoundedMetadataReader.regular(root.resolve("mvnw.cmd"));
        boolean wrapper = hasMavenWrapper
                && BoundedMetadataReader.regular(root.resolve(".mvn/wrapper/maven-wrapper.properties"));
