package gold.debug.windowstolinux.shared.analyze.ecosystem.php.project.service;
...
/** Provides the {@code PhpServiceDeploymentInspector} type. / 提供 {@code PhpServiceDeploymentInspector} 类型。 */
public final class PhpServiceDeploymentInspector implements DeploymentTypeInspector {
    private final ServiceDeploymentInspectorSupport support = new ServiceDeploymentInspectorSupport(DeploymentProjectType.PHP_SERVICE);
