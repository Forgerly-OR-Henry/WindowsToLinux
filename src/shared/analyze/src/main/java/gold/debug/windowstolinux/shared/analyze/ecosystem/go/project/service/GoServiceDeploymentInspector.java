package gold.debug.windowstolinux.shared.analyze.ecosystem.go.project.service;
...
/** Provides the {@code GoServiceDeploymentInspector} type. / 提供 {@code GoServiceDeploymentInspector} 类型。 */
public final class GoServiceDeploymentInspector implements DeploymentTypeInspector {
    private final ServiceDeploymentInspectorSupport support = new ServiceDeploymentInspectorSupport(DeploymentProjectType.GO_SERVICE);
