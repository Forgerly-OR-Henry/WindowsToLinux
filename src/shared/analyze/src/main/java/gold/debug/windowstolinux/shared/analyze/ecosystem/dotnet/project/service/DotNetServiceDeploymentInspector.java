package gold.debug.windowstolinux.shared.analyze.ecosystem.dotnet.project.service;
...
/** Provides the {@code DotNetServiceDeploymentInspector} type. / 提供 {@code DotNetServiceDeploymentInspector} 类型。 */
public final class DotNetServiceDeploymentInspector implements DeploymentTypeInspector {
    private final ServiceDeploymentInspectorSupport support = new ServiceDeploymentInspectorSupport(DeploymentProjectType.DOTNET_SERVICE);
