...
class LoopbackSshServerTest {
    ...
    private void connect(LoopbackSshServer fixture) throws Exception {
        try (SshClient client = SshClient.setUpDefaultClient()) {
            ...
            try (var session = client.connect("fixture", "127.0.0.1", fixture.server().getPort())
                ...
                session.addPasswordIdentity("fixture");
    ...
    @Test
    void rearmedAcceptMustCompleteBeforeExecutorsCanClose() throws Exception {
    ...
    @Test
    void backgroundExceptionFailsFixtureAndRestoresOriginalHandler() throws Exception {
    ...
    @Test
    void originalAssertionRemainsPrimaryWhenBackgroundCleanupAlsoFails() {
        var handler = Thread.getDefaultUncaughtExceptionHandler();
    ...
    @Test
    void fiftyRealConnectionsAndServerShutdownsLeaveNoResourcesOrExceptions() throws Exception {
