...
class DeploymentRuntimeArgumentsTest {
    ...
    void preservesExactBuildArchitectureInManagedRuntimeArguments() {
        ...
        assertEquals(List.of("python", "3.12", "demo.main", "UV_LOCKED"),
                arguments(DeploymentProjectType.PYTHON_SERVICE, DeploymentBuildToolType.UV_LOCKED,
                        new DeploymentRuntimeSpecification.PythonService("3.12", "demo.main", TCP)));
        assertEquals(List.of("static", "dist", "8080", "YARN"),
                arguments(DeploymentProjectType.STATIC_SITE, DeploymentBuildToolType.YARN,
                        new DeploymentRuntimeSpecification.StaticSite("dist", OptionalInt.of(22),
                                new HealthCheck.Http(URI.create("http://127.0.0.1:8080/"), 200, 10))));
        assertEquals(List.of("kotlin", "21", "demo", "demo.MainKt", "KOTLINC"),
                arguments(DeploymentProjectType.KOTLIN_SERVICE, DeploymentBuildToolType.KOTLINC,
                        new DeploymentRuntimeSpecification.KotlinService("2.0.21", "demo", "demo.MainKt", TCP)));
        assertEquals(List.of("phpcli", "8.3", "public", "public/index.php", "8080"),
                arguments(DeploymentProjectType.PHP_SERVICE, DeploymentBuildToolType.PHP_CLI,
                        new DeploymentRuntimeSpecification.PhpService("8.3", "public", "public/index.php", 8080, TCP)));
        assertEquals(List.of("rubycli", "3.3.5", "source", "server.rb", "8080"),
                arguments(DeploymentProjectType.RUBY_SERVICE, DeploymentBuildToolType.RUBY_CLI,
                        new DeploymentRuntimeSpecification.RubyService("3.3.5", "source", "server.rb", 8080, TCP)));
        assertEquals(List.of("cmake", "w2l-release", "demo", "demo"),
                arguments(DeploymentProjectType.CMAKE_SERVICE, DeploymentBuildToolType.CMAKE,
    ...
    private static List<String> arguments(DeploymentProjectType type, DeploymentBuildToolType tool,
        ...
        DeploymentProjectFacts facts = type == DeploymentProjectType.CMAKE_SERVICE
                ...
                : new DeploymentProjectFacts(Path.of("."), "demo", type, tool, List.of(), List.of(), List.of());
