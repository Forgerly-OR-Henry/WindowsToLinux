...
public final class PipBuildRenderer implements DeploymentBuildRenderer {
     ...
     */
    @Override public Set<DeploymentBuildToolType> buildTools() { return Set.of(DeploymentBuildToolType.PIP_LOCKED, DeploymentBuildToolType.PYTHON_STDLIB); }
    /**
    ...
    @Override public String render(DeploymentProjectFacts facts, DeploymentRuntimeSpecification runtime,
        ...
        if (facts.buildTool() == DeploymentBuildToolType.PYTHON_STDLIB)
            return PythonArchitectureBuildRenderer.render(DeploymentBuildToolType.PYTHON_STDLIB, facts, runtime, workspace,
                    limits, null, "test -f ./pyproject.toml");
