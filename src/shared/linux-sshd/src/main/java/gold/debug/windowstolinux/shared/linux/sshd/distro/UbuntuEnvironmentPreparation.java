...
public final class UbuntuEnvironmentPreparation {
    ...
    public static final int APT_LOCK_TIMEOUT_SECONDS = AptEnvironmentPreparationRenderer.LOCK_TIMEOUT_SECONDS;
    /** Restricted sudo policy path. / 受限 sudo 策略路径。 */
    public static final String SUDOERS_PATH = EnvironmentPreparationShellSupport.SUDOERS_PATH;
    /** Fixed Ubuntu baseline packages. / 固定 Ubuntu 基线软件包。 */
    public static final List<String> PACKAGES = PreparationPackageCatalog.APT_BASE;
    ...
    public static final List<String> EXPERIMENTAL_LANGUAGE_PACKAGES_2404 =
            PreparationPackageCatalog.UBUNTU_2404_EXPERIMENTAL;
    ...
    public static String renderSudoers(String username) {
        return EnvironmentPreparationShellSupport.renderSudoers(username);
    }
    ...
    public static String renderScript(String username, String version) {
        ...
        PreparationRuntimeProfile runtime = "24.04".equals(version)
                ? PreparationRuntimeProfile.UBUNTU_2404 : PreparationRuntimeProfile.UBUNTU_2204;
