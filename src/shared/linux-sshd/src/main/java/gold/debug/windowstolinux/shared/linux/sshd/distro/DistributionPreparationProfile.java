...
record DistributionPreparationProfile(
        String id,
        String variant,
        String version,
        ...
        PreparationRuntimeProfile runtimeProfile
) {
    DistributionPreparationProfile {
        id = token(id, "id");
        ...
        runtimeProfile = Objects.requireNonNull(runtimeProfile, "runtimeProfile");
    }
