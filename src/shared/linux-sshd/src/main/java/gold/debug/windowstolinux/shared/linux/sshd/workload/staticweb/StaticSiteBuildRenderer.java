package gold.debug.windowstolinux.shared.linux.sshd.workload.staticweb;
...
import gold.debug.windowstolinux.shared.linux.sshd.ecosystem.node.build.NodePackageBuildScript;
...
public final class StaticSiteBuildRenderer implements DeploymentBuildRenderer {
    ...
    @Override public String render(DeploymentProjectFacts facts, DeploymentRuntimeSpecification runtime,
        ...
        String command;
        if (facts.buildTool() == DeploymentBuildTool.STATIC_SITE_BUILD) {
