package gold.debug.windowstolinux.shared.linux.sshd.ecosystem.rust.build;
...
/** Provides the {@code RustBuildRenderer} type. / 提供 {@code RustBuildRenderer} 类型。 */
public final class RustBuildRenderer implements DeploymentBuildRenderer {
 private final EcosystemServiceBuildSupport support=new EcosystemServiceBuildSupport(DeploymentProjectType.RUST_SERVICE);
 /** Returns the supported deployment project type. / 返回支持的部署项目类型。 */
 public DeploymentProjectType projectType(){return DeploymentProjectType.RUST_SERVICE;}
