 ...
 */
final class SshdPhaseOneRemoteSession implements PhaseOneRemoteSession {
    ...
    SshdPhaseOneRemoteSession(SshClient client, ClientSession session,
        ...
        this.protocol = new PhaseOneProtocolExecutor(commands);
    ...
    @Override
    public PhaseOneEnvironmentPreparationResult preparePhaseOneEnvironment(
            PhaseOneEnvironmentPreparationApproval approval) throws LinuxOperationException {
    ...
    public void close() {
        try {
            ...
            SshdPhaseOneLinuxGateway.closeQuietly(client);
        }
    }
}
