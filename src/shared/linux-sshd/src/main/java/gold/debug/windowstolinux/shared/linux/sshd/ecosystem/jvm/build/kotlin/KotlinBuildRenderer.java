package gold.debug.windowstolinux.shared.linux.sshd.ecosystem.jvm.build.kotlin;
...
/** Provides the {@code KotlinBuildRenderer} type. / 提供 {@code KotlinBuildRenderer} 类型。 */
public final class KotlinBuildRenderer implements DeploymentBuildRenderer {
 private final EcosystemServiceBuildSupport support=new EcosystemServiceBuildSupport(DeploymentProjectType.KOTLIN_SERVICE);
 /** Returns the supported deployment project type. / 返回支持的部署项目类型。 */
 public DeploymentProjectType projectType(){return DeploymentProjectType.KOTLIN_SERVICE;}
