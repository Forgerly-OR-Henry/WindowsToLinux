...
/**
 * Fixed read-only shell program for collecting Phase Two distribution, container, and CPU facts.
 *
 * <p>用于采集二期发行版、容器和 CPU 事实的固定只读 Shell 程序。
 */
public final class PhaseTwoCapabilityProbeScript {
    private PhaseTwoCapabilityProbeScript() {
    }
