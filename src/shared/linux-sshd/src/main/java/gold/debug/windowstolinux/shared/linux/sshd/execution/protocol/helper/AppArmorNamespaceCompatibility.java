...
public final class AppArmorNamespaceCompatibility {
    private AppArmorNamespaceCompatibility() { }
    ...
    public static String expand(String script) {
        if (script.contains("# @compat:apparmor@\n")) script = script.replace("# @compat:apparmor@\n", resource("apparmor-namespace.sh"));
        return script;
    }

    private static String resource(String name) {
        try (var input = AppArmorNamespaceCompatibility.class.getResourceAsStream(name)) {
