...
public final class SystemdHealthProbe {
     ...
     * @throws NullPointerException if a required input is absent / 必需输入缺失时
     */
    public HealthCheckResult check(ManagedApplication application, HealthCheck healthCheck)
            throws LinuxOperationException {
        Objects.requireNonNull(application, "application");
        return gold.debug.windowstolinux.shared.linux.sshd.execution.protocol.runtime.ApplicationHealthProbe
                .check(commands, application, healthCheck);
    }
    ...
    public HealthCheckResult checkUnit(String systemdUnit, HealthCheck healthCheck) throws LinuxOperationException {
        ...
        return new HealthCheckResult(
                ...
                result.succeeded()
                        ? "Layered health check completed"
