 ...
 */
public record PhaseOneEnvironmentPreparationResult(
        ServerCapabilities capabilities,
        String evidence
) {
    /**
     * Creates a {@code PhaseOneEnvironmentPreparationResult} instance.
     *
     * <p>创建 {@code PhaseOneEnvironmentPreparationResult} 实例。
     *
     * @param capabilities the {@code capabilities} value / {@code capabilities} 值
     * @param evidence the {@code evidence} value / {@code evidence} 值
     ...
     */
    public PhaseOneEnvironmentPreparationResult {
