...
public enum DatabaseEngineType {
    SQLITE(0, DatabaseCategoryType.SQL), POSTGRESQL(5432, DatabaseCategoryType.SQL), MYSQL(3306, DatabaseCategoryType.SQL), MARIADB(3306, DatabaseCategoryType.SQL), REDIS(6379, DatabaseCategoryType.OTHER);
