...
/**
 * Live, non-secret host facts used only to decide whether a Phase Two plan may be offered.
 *
 * <p>仅用于决定能否提供二期计划的实时、非秘密主机事实。
 *
 ...
 */
public record PhaseTwoLinuxCapabilities(
        PhaseTwoLinuxDistro distro,
        String version,
        String architecture,
    ...
    /**
     * Creates a {@code PhaseTwoLinuxCapabilities} instance.
     *
     * <p>创建 {@code PhaseTwoLinuxCapabilities} 实例。
     */
    public PhaseTwoLinuxCapabilities {
