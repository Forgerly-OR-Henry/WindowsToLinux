 ...
 */
public record ComponentIsolationRequirements(
    ...
    public static ComponentIsolationRequirements managed() {
        return new ComponentIsolationRequirements(false, false, false, false);
    }
