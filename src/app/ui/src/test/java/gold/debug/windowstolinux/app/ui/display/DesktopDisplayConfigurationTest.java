...
class DesktopDisplayConfigurationTest {
    ...
    void savedLanguageAndThemeOverrideSystemDefaults() {
        DesktopDisplayConfiguration english = DesktopDisplayConfiguration.fromStoredValues(
        ...
        DesktopDisplayConfiguration chinese = DesktopDisplayConfiguration.fromStoredValues(
