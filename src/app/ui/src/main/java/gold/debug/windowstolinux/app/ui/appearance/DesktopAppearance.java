 ...
 */
public record DesktopAppearance(String localeTag, ThemeMode themeMode) {
    /**
     * Creates a {@code DesktopAppearance} instance.
     *
     * <p>创建 {@code DesktopAppearance} 实例。
     *
     * @param localeTag the {@code localeTag} value / {@code localeTag} 值
     * @param themeMode the {@code themeMode} value / {@code themeMode} 值
     ...
     */
    public static DesktopAppearance defaults() {
     ...
     * @return the operation result / 操作结果
     */
    public static DesktopAppearance defaults(Locale systemLocale) {
        return new DesktopAppearance(MessageCatalog.defaultLanguageTag(systemLocale), ThemeMode.SYSTEM);
    }
     ...
     * @throws NullPointerException if a required argument is {@code null} / 必要参数为 {@code null} 时
     */
    public static DesktopAppearance fromStoredValues(String storedLocaleTag, String storedThemeMode,
                                                     Locale systemLocale) {
        ...
        return new DesktopAppearance(localeTag, ThemeMode.fromStoredValue(storedThemeMode));
    }
}
