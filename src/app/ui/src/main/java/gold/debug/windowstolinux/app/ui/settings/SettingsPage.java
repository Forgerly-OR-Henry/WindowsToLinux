...
public final class SettingsPage {
    ...
    public SettingsPageState captureState() { return new SettingsPageState(); }
    /** Restores settings state; no unsaved value exists. / 恢复设置状态；不存在未保存值。 */
    public void restoreState(SettingsPageState state) { java.util.Objects.requireNonNull(state, "state"); }
