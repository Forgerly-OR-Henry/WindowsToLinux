...
public final class DesktopComboBoxUi extends FlatComboBoxUI {
     ...
     */
    public static ComponentUI createUI(JComponent component) { return new DesktopComboBoxUi(); }
     ...
     */
    @Override public Dimension getMinimumSize(JComponent component) {
        Dimension size=super.getMinimumSize(component);
        if(component.isDisplayable()) {
            if(fixedWidth<0)fixedWidth=size.width;
