...
/**
 * Provides the {@code DesktopComponents} implementation.
 *
 * <p>提供 {@code DesktopComponents} 实现。
 */
public final class DesktopComponents {
    private final ThemePalette palette;

    /**
     * Creates a {@code DesktopComponents} instance.
     *
     * <p>创建 {@code DesktopComponents} 实例。
     *
     * @param palette the {@code palette} value / {@code palette} 值
     * @throws NullPointerException if a required argument is {@code null} / 必要参数为 {@code null} 时
     */
    public DesktopComponents(ThemePalette palette) {
