 ...
 */
@EnabledIfSystemProperty(named = "phase1.runtime.rollback", matches = "true")
class PhaseOneUbuntuRollbackAcceptanceIT {
    @TempDir
    Path temporaryDirectory;

    @Test
    void restoresTheLiveVersionAfterAnUnhealthyShortDowntimeUpdate() throws Exception {
        String v1Property = System.getProperty("phase1.rollback.v1.source");
        String v2Property = System.getProperty("phase1.rollback.v2.source");
        ...
        assertTrue(v1Property != null && !v1Property.isBlank(), "phase1.rollback.v1.source is required");
        assertTrue(v2Property != null && !v2Property.isBlank(), "phase1.rollback.v2.source is required");
        ...
        int proofPort = Integer.getInteger("phase1.rollback.port", 18083);
        ...
        char[] masterPassword = "phase1-rollback-master".toCharArray();
        try (DesktopDatabase database = DesktopDatabase.open(temporaryDirectory.resolve("desktop-data"))) {
            ...
            ServerProfile profile = new ServerProfile("ubuntu-phase1-rollback", host, 22, username,
                    "ssh/ubuntu-phase1-rollback/password", CredentialStorageMode.MASTER_PASSWORD);
            ...
            var capabilities = service.verifyServer(profile, CredentialStorageMode.MASTER_PASSWORD,
                    "phase1-rollback-master".toCharArray(), fingerprint -> true);
            ...
            LifecycleActionResult refreshed = service.executeLifecycleResultWithStoredPassword(firstRequest.application(),
                    ...
                    "phase1-rollback-master".toCharArray());
