...
/**
 * Provides the {@code Argon2AesGcmCrypto} implementation.
 *
 * <p>提供 {@code Argon2AesGcmCrypto} 实现。
 */
public final class Argon2AesGcmCrypto implements AutoCloseable {
    ...
    /**
     * Creates a {@code Argon2AesGcmCrypto} instance.
     *
     * <p>创建 {@code Argon2AesGcmCrypto} 实例。
     *
     * @param masterPassword the {@code masterPassword} value / {@code masterPassword} 值
     * @throws IllegalArgumentException if an argument violates the required constraints / 参数违反必要约束时
     */
    public Argon2AesGcmCrypto(char[] masterPassword) {
