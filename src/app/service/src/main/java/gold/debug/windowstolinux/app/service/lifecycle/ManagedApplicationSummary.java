...
/**
 * Persisted ownership, successful deployment contract and artifact version; not a remote runtime claim.
 *
 * <p>已持久化的资源归属、成功部署契约和制品版本；并非远端运行时状态声明。
 *
 * @param application the {@code application} value / {@code application} 值
 * @param currentArtifactSha256 the {@code currentArtifactSha256} value / {@code currentArtifactSha256} 值
...
public record ManagedApplicationSummary(
        ...
        Optional<String> currentArtifactSha256,
    ...
    public ManagedApplicationSummary {
        ...
        currentArtifactSha256 = Objects.requireNonNull(currentArtifactSha256, "currentArtifactSha256");
