 ...
 */
public final class ReadOnlyDeploymentAgentFacade {
    private final DeploymentAnalysisCoordinator analyzer;
    private final ReviewedDeploymentPlanner planner;

    /**
     * Creates a {@code ReadOnlyDeploymentAgentFacade} instance.
     *
     * <p>创建 {@code ReadOnlyDeploymentAgentFacade} 实例。
     */
    public ReadOnlyDeploymentAgentFacade() {
        this(new DeploymentAnalysisCoordinator(), new ReviewedDeploymentPlanner());
    }

    ReadOnlyDeploymentAgentFacade(DeploymentAnalysisCoordinator analyzer, ReviewedDeploymentPlanner planner) {
