...
public record AiRoleAssignment(AiCollaborationRole role, String providerId) {
    ...
    public static AiRoleAssignment fromStored(StoredAiRoleAssignment stored) {
        return new AiRoleAssignment(AiCollaborationRole.valueOf(stored.role()), stored.profileId());
    }
}
