...
- 文档版本：`2.30.0-authenticated-maintenance-handoff`
- 文档状态：**桌面更新/卸载主进程交接已有严格版本化、用途隔离和 HMAC-SHA256 认证的跨进程载荷，SQLite v9 备份输入与固定 `WindowsToLinux/*` Credential Manager 删除能力保持完成；认证密钥交付、交接文件 ACL、生产维护执行器及其产品入口仍标记 `RUNTIME-PENDING`**
- 更新日期：2026-08-22
