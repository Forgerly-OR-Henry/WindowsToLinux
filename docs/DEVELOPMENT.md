...
- 文档版本：`2.12.0-phase3-ubuntu-fixture-regression`
...
| Linux 运行验证 | 迁移前 Ubuntu 24.04 x86-64 已实际验证环境准备、六类二期构建发布及代表性生命周期；当前 helper v3 已验证六种高级语言和两组件整应用；新增发行版已有显式产品入口验收框架 | 收敛后的 Spring Boot、Podman、Ubuntu 22.04、CentOS Stream 9/10 及新增发行版实机仍为 `RUNTIME-PENDING` |
