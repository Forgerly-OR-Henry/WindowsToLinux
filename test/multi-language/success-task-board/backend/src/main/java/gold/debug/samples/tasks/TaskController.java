...
public class TaskController {
    ...
    Object transition(@PathVariable long id, @RequestParam long projectId, @RequestBody Transition v)
        throws Exception {
        return store.transition(id, projectId, v);
    }
    @PostMapping("/api/tasks/{id}/comments")
    Object comment(@PathVariable long id, @RequestParam long projectId, @RequestBody Comment v)
        throws Exception {
