...
public final class FixtureHandler implements HttpHandler {
    ...
    public FixtureHandler(FixtureConfiguration configuration) { this.configuration = configuration; }
    @Override public void handle(HttpExchange exchange) throws IOException {
        ...
        if (status != 503 && (summary || FixtureConfiguration.mode().equals("json"))) {
            ...
            } catch (IllegalArgumentException error) { status = 400; body = "invalid-values"; }
        }
